  ...
  return (
    <>
      <SectionWrapper id="home">
        ...
        <div>
          <p>
            Experienced MERN stack developer with hands-on experience in developing robust web applications. Proficient in <span>Node.js</span> ,
            <span>React.js</span> ,<span>Python</span> and database management systems like <span>MySQL</span> and <span> MongoDB</span>. Skilled in
            creating visually appealing interfaces and collaborating with cross-functional teams to deliver high-quality solutions.
          </p>
        </div>
      ...
      <SectionWrapper id="about">
        <div className="relative">
          ...
          <div>
            <figure>
              <Image src="/personal.jpg" alt="Picture of the author" width={500} height={500} />
            </figure>
          </div>
        </div>
      </SectionWrapper>
      <SectionWrapper id="exp">
        ...
        <div>
          <>
            ...
            <p>2023 - Present</p>
            <ul>
              <li> Develop high-quality, reliable code for various client projects, including Goudla BlockChain and Haitmi Resort projects.</li>
              <li> Work with creative directors to research, develop, and design technical solutions that meet business needs.</li>
              <li> Collaborate with designers, project managers, and engineers to turn creative ideas into functional products. </li>
              <li> Support the engineering team by sharing knowledge, mentoring, and fostering teamwork.</li>
            </ul>
          </>
        </div>
      </SectionWrapper>
        ...
        {projectsData.projects?.map((obj, _ind) => {
          return (
            <article key={obj.id}>
              ...
              <figure>
                <Image src={obj.mainImageUrl.url} alt={obj.mainImageUrl.alt} width={500} height={500} />
              </figure>
            </article>
          );
        })}
      ...
      <SectionWrapper id="contact">
        <div>
          ...
          <h2>Get In Touch </h2>
          <p>
            Although I&rsquo;m not currently looking for any new opportunities, my inbox is always open. Whether you have a question or just want to
