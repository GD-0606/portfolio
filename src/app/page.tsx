  ...
  return (
    <>
      <SectionWrapper id="home">
        <div className="">
          <h1 className="mb-[30px] ml-[4px] mt-[10px] text-green font-mono font-normal text-h1-heading">
            Hi, my name is
          </h1>
        </div>
        <div className="">
        ...
        <div className="">
          <h3 className="text-big-heading mt-[5px] text-slate leading-[0.9]">
        ...
        <div className="relative">
          <p className="mt-[40px] w-8/12">
            ...
            scalable web applications and APIs.Proficient in{" "}
            <span>Node.js</span> ,<span>React.js</span> ,<span>MongoDB</span>{" "}
            and <span>Express.js</span>. Strong understanding of RESTFUL
            architecture microservices and cloud-native development. Passionate
            about writing clean code, learning new technologies and delivering
      ...
      <SectionWrapper id="about" className="max-w-[900px]">
        ...
        <div className="relative grid grid-cols-[3fr_2fr] gap-[50px]">
          <div className="relative">
            <div>
              <p className="mb-[20px]">
                Hello! My name is Gopi, and I love building things for the web.
                My web development journey began in 2022 when I customized a
              ...
              <p className="mb-[20px]">
                ...
                working at <span>a branding agency </span> ,{" "}
                <span>a startup </span> and <span>an advertising company.</span>{" "}
                My main focus these days is building accessible, inclusive
                products and digital experiences at <span>Entitledarts</span>{" "}
      ...
      <SectionWrapper
        id="contact"
        className="max-w-[600px] mt-0 mb-[100px] text-center"
      >
